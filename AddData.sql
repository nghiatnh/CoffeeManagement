...
-- TABLE DISCOUNTCODES
INSERT INTO DISCOUNTCODES(NAME, COUNT, LIMITPRICE, MINPRICE, DUETIME, IDCUSTOMER) VALUES
('GIAM BAT KY', 0.1, 20000, 0, '14-08-2022', NULL),
('GIAM BAT KY CHO DON > 200000', 0.1, 50000, 200000, '14-08-2022', NULL),
('GIAM CHO KHACH HANG 1', 0.1, 50000, 0, '14-08-2022', 1);
...
-- TABLE BILLS
INSERT INTO BILLS(ID, IDSTAFF, IDCUSTOMER, IDDISCOUNT) VALUES
(1, 1, 1, NULL),
(2, 1, 2, 3);